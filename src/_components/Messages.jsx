...
export const SectionsData = {
  ...
  Skill3: "Pintura",
  Skill4: "Plastica",
  TitleEventos: "Proximos Eventos",
  MusicTitle: "Musica",
  MusicaSubtitle1: "Trabajos",
  MusicaSubtitle2: "Musicos Estables",
  TatuajeTitle: "Tatuaje",
  TatuajeSubtitle1: "Ganesha Art Tattoo Studio",
  TatuajeSubtitle2: "Trabajos",
  PinturaTitle: "Pintura",
  PinturaSubtitle1: "Trabajos",
  PlasticaTitle: "Plastica",
  PlasticaSubtitle1: "Trabajos",
  EshopTitle: "E-Shop",
...
export const Eventos = [
  {
    Fecha: "13/05 al 20/05",
    NombreEvento: "Semana Sailor",
    Direccion: "25% off en Tattoo",
    Hora: "",
    Linea1: "Reserva tu turno desde la pagina",
    Linea2: "con el codigo 'SailorTattoo",
    Linea3: "y recibis un 5% de descuento adicional",
  },

  {
    Fecha: "13/05",
    NombreEvento: "en vivo en Antiguas Lunas",
    Direccion: "Belgrano",
    Hora: "12hs",
    Linea1: "registrandote desde este sitio participas de",
    Linea2: "2 pintas +",
    Linea3: "porcion de papas",
  },
];
//------------------------------------------------------------------------------------------------------
//PICTURES_SECTION
